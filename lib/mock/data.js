...
mockNegocios.forEach((n, i) => {
  if (!n.codigo_resena) {
    n.codigo_resena = `MOCK${String(i + 1).padStart(2, '0')}`
  }
})
...
export const mockResenas = [
  {
    ...
    negocio_id: 'n1',
    calificacion: 5,
    texto: 'Excelente brunch y café. Muy recomendable.',
    estado: 'publicada',
    creado_en: daysFromNow(-12),
  },
  {
    id: 'r2',
    negocio_id: 'n1',
    calificacion: 4,
    texto: 'Buena atención, volvería.',
    estado: 'publicada',
    creado_en: daysFromNow(-30),
  },
]
