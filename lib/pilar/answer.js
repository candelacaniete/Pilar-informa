...
export function fallbackAnswer(question, context) {
  ...
  if (intent === 'gastro' || intent === 'mascotas' || intent === 'negocio') {
  ...
  return `Soy Pilar, la asistente de Guía Pilar. Puedo decirte farmacias de turno, promociones, eventos, restaurantes y locales de la guía. Preguntame, por ejemplo: “farmacia de turno en Zelaya” o “qué eventos hay esta semana”.`
}
...
export async function answerWithGemini(question, context) {
  ...
  const system = `Sos Pilar, asistente de Guía Pilar, la guía local de Pilar (Buenos Aires).
...
No hables de temas fuera de Guía Pilar.`
