...
export function fallbackAnswer(question, context) {
  ...
  if (intent === 'farmacia') {
    ...
    if (!list.length) {
      return zona
        ? `Hoy no tengo una farmacia de turno cargada en ${zona}. Probá preguntar por otra zona o mirá el listado de la semana en Farmacias de turno.`
        : 'Hoy todavía no hay farmacias de turno cargadas. Cuando el equipo las cargue, te las voy a poder decir.'
    }
