...
export async function getMascotaAvisoByResolveToken(token) {
  ...
  // Service-visible fields for owner manage page — use admin client if needed.
  // Server cookie client won't see non-approved via RLS; use service for token lookup.
