...
/** Copy distinto por slot para house banners (mismo diseño, otro texto). */
export const HOUSE_BANNER_COPY = {
  1: {
    title: '¿Querés aparecer acá?',
    text: 'Escribinos y reservá este espacio del mes.',
  },
  2: {
  ...
  3: {
    title: 'Espacio disponible este mes',
    text: 'Sumate a Guía Pilar.',
  },
  4: {
    title: '¿Tu negocio necesita más visibilidad?',
    text: 'Este espacio te espera.',
  },
}

export function getBannerSlot(slots, slotNumber) {
  return slots.find((s) => s.slot === slotNumber) || { slot: slotNumber, banner: null }
}
